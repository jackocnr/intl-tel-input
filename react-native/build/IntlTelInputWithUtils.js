...
(function() {
  ...
  var J = {
    ...
    AU: [
      ...
      [, , "4(?:79[01]|83[0-389]|94[0-478])\\d{5}|4(?:[0-36]\\d|4[047-9]|5[0-25-9]|7[02-8]|8[0-24-9]|9[0-37-9])\\d{6}", , , , "412345678", , , [9]],
    ...
    EH: [
      ...
      [, , "(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[0167]\\d|2[0-8]|5[0-3]|8[0-7]))\\d{6}", , , , "650123456"],
    ...
    MN: [
      ...
      [, , "(?:83[01]|92[0139])\\d{5}|(?:5[05]|6[069]|72|8[015689]|9[013-9])\\d{6}", , , , "88123456", , , [8]],
      [, , , , , , , , , [-1]],
      [, , , , , , , , , [-1]],
      [, , , , , , , , , [-1]],
      [, , , , , , , , , [-1]],
    ...
    SG: [, [, , "(?:(?:1\\d|8)\\d\\d|7000)\\d{7}|[3689]\\d{7}", , , , , , , [8, 10, 11]], [
      ...
      ,
      [8]
    ], [, , "897[0-5]\\d{4}|(?:8(?:0[1-9]|[1-8]\\d|9[0-6])|9[0-8]\\d)\\d{5}", , , , "81234567", , , [8]], [, , "(?:18|8)00\\d{7}", , , , "18001234567", , , [10, 11]], [, , "1900\\d{7}", , , , "19001234567", , , [11]], [, , , , , , , , , [-1]], [, , , , , , , , , [-1]], [, , "(?:3[12]\\d|666)\\d{5}", , , , "31234567", , , [8]], "SG", 65, "0[0-3]\\d", , , , , , , , [[, "(\\d{4,5})", "$1", ["1[013-9]|77", "1(?:[013-8]|9(?:0[1-9]|[1-9]))|77"]], [, "(\\d{4})(\\d{4})", "$1 $2", ["[369]|8(?:0[1-9]|[1-9])"]], [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["8"]], [
      ,
      "(\\d{4})(\\d{4})(\\d{3})",
      "$1 $2 $3",
      ["7"]
...
// react-native/src/intl-tel-input/intlTelInputWithUtils.ts
...
var IntlTelInput = forwardRef(function IntlTelInput2({
  ...
  useEffect(() => {
    if (!itiRef.current) {
      itiRef.current = intlTelInputWithUtils_default(textInputRef.current, initOptions);
  ...
  useEffect(() => {
    const utilsAvailable = !!intlTelInputWithUtils_default.utils;
    if (utilsAvailable) {
      updatePlaceholder();
    }
  }, [intlTelInputWithUtils_default.utils]);
  useEffect(() => {
  }, [disabled]);
  useEffect(() => {
    if (searchQuery.trim() === "") {
  ...
  const renderCountryItem = ({ item }) => /* @__PURE__ */ React.createElement(
    ...
    initOptions.showFlags !== false && /* @__PURE__ */ React.createElement(Text, { style: [styles.flag, flagStyle] }, getCountryFlag(item.iso2)),
    /* @__PURE__ */ React.createElement(Text, { style: [styles.countryName, countryNameStyle] }, item.name),
    /* @__PURE__ */ React.createElement(Text, { style: [styles.dialCode, dialCodeStyle] }, "+", item.dialCode)
  );
  return /* @__PURE__ */ React.createElement(View, { style: styles.container }, /* @__PURE__ */ React.createElement(View, { style: [styles.inputContainer, style] }, initOptions.allowDropdown !== false && /* @__PURE__ */ React.createElement(
    TouchableOpacity,
    {
    ...
    initOptions.showFlags !== false && selectedCountry && /* @__PURE__ */ React.createElement(Text, { style: [styles.selectedFlag, flagStyle] }, getCountryFlag(selectedCountry.iso2)),
    /* @__PURE__ */ React.createElement(Text, { style: styles.dropdownArrow }, "\u25BC"),
    initOptions.separateDialCode && selectedCountry && /* @__PURE__ */ React.createElement(Text, { style: [styles.selectedDialCode, textStyle] }, "+", selectedCountry.dialCode)
    ...
    /* @__PURE__ */ React.createElement(SafeAreaView, { style: [styles.modalContainer, dropdownContainerStyle] }, /* @__PURE__ */ React.createElement(View, { style: styles.modalHeader }, /* @__PURE__ */ React.createElement(
      TouchableOpacity,
      {
    ...
    )), initOptions.countrySearch !== false && /* @__PURE__ */ React.createElement(
      TextInput,
      {
...
var reactNativeWithUtils_default = IntlTelInput;
export {
  reactNativeWithUtils_default as default,
