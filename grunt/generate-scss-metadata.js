  ...
  grunt.registerTask('generate-scss-metadata', async function() {
    ...
    async function generateFlagMetadataAndSprite() {
      try {
        ...
        const spriteFile1x = "build/img/flags.webp";
        const spriteFile2x = "build/img/flags@2x.webp";
        ...
        // Create 1x WebP sprite
        await createSprite(scaledImages1x, totalWidth, maxHeight, spriteFile1x);
        console.log(`1x combined image saved as ${spriteFile1x}`);

        // Create 2x WebP sprite
        await createSprite(scaledImages2x, totalWidth * 2, maxHeight * 2, spriteFile2x);
        console.log(`2x combined image saved as ${spriteFile2x}`);
    ...
    async function createSprite(images, width, height, outputFile) {
