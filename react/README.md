...
## Demo and Examples
You can see a live demo and example code showcasing the React component on the [demo site](https://intl-tel-input.com/examples/react-component).
...
**initOptions**  
Type: `Object`  
An object containing the [initialisation options](https://intl-tel-input.com/docs/options.html) to pass to the plugin. These can be used exactly the same way as with the main JavaScript plugin.
