...
An Angular component for the [intl-tel-input](https://github.com/jackocnr/intl-tel-input) JavaScript library. View the [source code](https://github.com/jackocnr/intl-tel-input/blob/master/packages/angular/src/IntlTelInput.ts).
