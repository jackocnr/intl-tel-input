...
The utils script (packages/core/src/js/utils.js) is a custom build of Google's [libphonenumber](https://github.com/google/libphonenumber) which enables the following features:
