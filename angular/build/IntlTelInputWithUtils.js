...
import { Component, Input as Input3, ViewChild, Output as Output2, EventEmitter as EventEmitter2, forwardRef as forwardRef2 } from "@angular/core";

// node_modules/@angular/forms/fesm2022/forms.mjs
import * as i03 from "@angular/core";
import { InjectionToken as InjectionToken4, Directive as Directive2, forwardRef, Optional as Optional2, Inject as Inject2, \u0275isPromise as _isPromise, \u0275isSubscribable as _isSubscribable, \u0275RuntimeError as _RuntimeError2, Self, untracked, computed, signal, EventEmitter, Input as Input2, Host, SkipSelf, booleanAttribute as booleanAttribute2, ChangeDetectorRef as ChangeDetectorRef3, Output, inject as inject3, Injectable as Injectable3, NgModule, Version as Version2 } from "@angular/core";

// node_modules/@angular/common/fesm2022/location-Dq4mJT-A.mjs
import * as i0 from "@angular/core";
import { InjectionToken as InjectionToken2, inject, Injectable, Optional, Inject, \u0275\u0275inject as __inject } from "@angular/core";
...
var PlatformLocation = class _PlatformLocation {
  ...
  static \u0275prov = i0.\u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: _PlatformLocation, providedIn: "platform", useFactory: () => inject(BrowserPlatformLocation) });
};
i0.\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: PlatformLocation, decorators: [{
  type: Injectable,
  args: [{ providedIn: "platform", useFactory: () => inject(BrowserPlatformLocation) }]
}] });
var LOCATION_INITIALIZED = new InjectionToken2(ngDevMode ? "Location Initialized" : "");
...
var LocationStrategy = class _LocationStrategy {
  ...
  static \u0275prov = i0.\u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: _LocationStrategy, providedIn: "root", useFactory: () => inject(PathLocationStrategy) });
};
i0.\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: LocationStrategy, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root", useFactory: () => inject(PathLocationStrategy) }]
}] });
var APP_BASE_HREF = new InjectionToken2(ngDevMode ? "appBaseHref" : "");
...
import { \u0275registerLocaleData as _registerLocaleData, Version, \u0275\u0275defineInjectable as __defineInjectable, inject as inject2, InjectionToken as InjectionToken3, \u0275RuntimeError as _RuntimeError, \u0275formatRuntimeError as _formatRuntimeError, PLATFORM_ID, Injectable as Injectable2, \u0275IMAGE_CONFIG as _IMAGE_CONFIG, Renderer2, ElementRef, Injector, DestroyRef, \u0275performanceMarkFeature as _performanceMarkFeature, NgZone, ApplicationRef, booleanAttribute, numberAttribute, ChangeDetectorRef, \u0275IMAGE_CONFIG_DEFAULTS as _IMAGE_CONFIG_DEFAULTS, \u0275unwrapSafeValue as _unwrapSafeValue, Input, Directive } from "@angular/core";
...
function processConfig(config2) {
  ...
  return Object.assign({}, _IMAGE_CONFIG_DEFAULTS, config2, sortedBreakpoints);
}
...
var NG_VALUE_ACCESSOR = new InjectionToken4(ngDevMode ? "NgValueAccessor" : "");
...
var COMPOSITION_BUFFER_MODE = new InjectionToken4(ngDevMode ? "CompositionEventMode" : "");
...
var NG_VALIDATORS = new InjectionToken4(ngDevMode ? "NgValidators" : "");
var NG_ASYNC_VALIDATORS = new InjectionToken4(ngDevMode ? "NgAsyncValidators" : "");
...
function toObservable(value) {
  ...
  if ((typeof ngDevMode === "undefined" || ngDevMode) && !_isSubscribable(obs)) {
    ...
    throw new _RuntimeError2(-1101, errorMessage);
  }
  return obs;
}
...
function controlParentException(nameOrIndex) {
  return new _RuntimeError2(1050, `formControlName must be used with a parent formGroup directive. You'll want to add a formGroup
...
function ngModelGroupException() {
  return new _RuntimeError2(1051, `formControlName cannot be used with an ngModelGroup parent. It is only compatible with parents
...
function missingFormException() {
  return new _RuntimeError2(1052, `formGroup expects a FormGroup instance. Please pass one in.
...
function groupParentException() {
  return new _RuntimeError2(1053, `formGroupName must be used with a parent formGroup directive.  You'll want to add a formGroup
    directive and pass it an existing FormGroup instance (you can create one in your class).
...
function arrayParentException() {
  return new _RuntimeError2(1054, `formArrayName must be used with a parent formGroup directive.  You'll want to add a formGroup
      directive and pass it an existing FormGroup instance (you can create one in your class).
...
function assertControlPresent(parent, isGroup, key) {
  ...
  if (!collection.length) {
    throw new _RuntimeError2(1e3, typeof ngDevMode === "undefined" || ngDevMode ? noControlsError(isGroup) : "");
  }
  if (!controls[key]) {
    throw new _RuntimeError2(1001, typeof ngDevMode === "undefined" || ngDevMode ? missingControlError(isGroup, key) : "");
  }
}
function assertAllValuesPresent(control, isGroup, value) {
  control._forEachChild((_, key) => {
    if (value[key] === void 0) {
      throw new _RuntimeError2(1002, typeof ngDevMode === "undefined" || ngDevMode ? missingControlValueError(isGroup, key) : "");
    }
  });
}
...
var CALL_SET_DISABLED_STATE = new InjectionToken4(typeof ngDevMode === "undefined" || ngDevMode ? "CallSetDisabledState" : "", {
  providedIn: "root",
...
function _throwMissingValueAccessorError(dir) {
  ...
  throw new _RuntimeError2(-1203, `No value accessor for form control ${loc}.`);
}
function _throwInvalidValueAccessorError(dir) {
  const loc = _describeControlLocation(dir);
  throw new _RuntimeError2(1200, `Value accessor was not provided as an array for form control with ${loc}. Check that the \`NG_VALUE_ACCESSOR\` token is configured as a \`multi: true\` provider.`);
}
...
function modelParentException() {
  return new _RuntimeError2(1350, `
...
function formGroupNameException() {
  return new _RuntimeError2(1351, `
...
function missingNameException() {
  return new _RuntimeError2(1352, `If ngModel is used within a form tag, either the name attribute must be set or the form
...
function modelGroupParentException() {
  return new _RuntimeError2(1353, `
...
var NgModel = class _NgModel extends NgControl {
  ...
  _updateDisabled(changes) {
    ...
    const isDisabled = disabledValue !== 0 && booleanAttribute2(disabledValue);
    resolvedPromise.then(() => {
...
var RadioControlValueAccessor = class _RadioControlValueAccessor extends BuiltInControlValueAccessor {
   ...
   */
  value;
  callSetDisabledState = inject3(CALL_SET_DISABLED_STATE, { optional: true }) ?? setDisabledStateDefault;
...
var NG_MODEL_WITH_FORM_CONTROL_WARNING = new InjectionToken4(ngDevMode ? "NgModelWithFormControlWarning" : "");
...
var SelectControlValueAccessor = class _SelectControlValueAccessor extends BuiltInControlValueAccessor {
  ...
  set compareWith(fn) {
    if (typeof fn !== "function" && (typeof ngDevMode === "undefined" || ngDevMode)) {
      throw new _RuntimeError2(1201, `compareWith must be a function, but received ${JSON.stringify(fn)}`);
    }
...
var RequiredValidator = class _RequiredValidator extends AbstractValidatorDirective {
  ...
  inputName = "required";
  /** @internal */
  normalizeInput = booleanAttribute2;
  /** @internal */
...
var NonNullableFormBuilder = class _NonNullableFormBuilder {
  ...
  static \u0275prov = i03.\u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.14", ngImport: i03, type: _NonNullableFormBuilder, providedIn: "root", useFactory: () => inject3(FormBuilder).nonNullable });
};
i03.\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i03, type: NonNullableFormBuilder, decorators: [{
  type: Injectable3,
  args: [{
    providedIn: "root",
    useFactory: () => inject3(FormBuilder).nonNullable
  }]
}] });
...
var IntlTelInputComponent = class {
  constructor() {
    ...
    this.initOptions = {};
    this.numberChange = new EventEmitter2();
    this.countryChange = new EventEmitter2();
    this.validityChange = new EventEmitter2();
    this.errorCodeChange = new EventEmitter2();
    this.iti = null;
...
IntlTelInputComponent = __decorateClass([
  ...
  `,
    providers: [
      {
        provide: NG_VALUE_ACCESSOR,
        useExisting: forwardRef2(() => IntlTelInputComponent),
        multi: true
      },
      {
        provide: NG_VALIDATORS,
