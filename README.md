...
1. Add the CSS
  ```html
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/intl-tel-input@25.8.1/build/css/intlTelInput.css">
  ```
...
2. Add the plugin script and initialise it on your input element
  ...
  <script>
    ...
    window.intlTelInput(input, {
      loadUtils: () => import("https://cdn.jsdelivr.net/npm/intl-tel-input@25.8.1/build/js/utils.js"),
    });
  </script>
  ```
