...
! function(a) {
  ...
  function e(b, c) {
    this.a = b, this.b = a.extend({}, h, c), this.c = h, this.ns = "." + f + g++, this.d = Boolean(b.setSelectionRange), this.e = Boolean(a(b).attr("placeholder")), this.f = f, this.init()
  }
  var f = "intlTelInput",
    g = 1,
    h = {
  ...
  a(b).load(function() {
    ...
    init: function() {
      var b = this;
      "auto" == this.b.defaultCountry ? a.get("http://ipinfo.io", function(a) {
        b.b.defaultCountry = a && a.country ? a.country.toLowerCase() : "", b._a()
      }, "jsonp") : this._a()
    },
    _a: function() {
      this.b.nationalMode && (this.b.autoHideDialCode = !1), navigator.userAgent.match(/IEMobile/i) && (this.b.autoFormat = !1), b.innerWidth < 500 && (this.b.responsiveDropdown = !0), this._b(), this._f(), this._h(), this._i()
    },
    _b: function() {
      this._d(), this._e()
    },
    ...
    _d: function() {
      ...
      if (this.b.onlyCountries.length)
        for (this.l = [], a = 0; a < this.b.onlyCountries.length; a++) {
          var b = this._y(this.b.onlyCountries[a], !0, !1);
          b && this.l.push(b)
        } else this.l = k;
      for (this.m = {}, a = 0; a < this.l.length; a++) {
        var c = this.l[a];
    ...
    _e: function() {
      ...
      for (var a = 0; a < this.b.preferredCountries.length; a++) {
        var b = this.b.preferredCountries[a],
          c = this._y(b, !1, !0);
    ...
    _f: function() {
      ...
      }).appendTo(b), this.preferredCountries.length && (this._g(this.preferredCountries, "preferred"), a("<li>", {
        "class": "divider"
      }).appendTo(this.i)), this._g(this.l, ""), this.j = this.i.outerHeight(), this.i.removeClass("v-hide").addClass("hide"), this.b.responsiveDropdown && this.i.outerWidth(this.g.outerWidth()), this.iItems = this.i.children(".country")
    },
    _g: function(a, b) {
    ...
    _h: function() {
      ...
      if (this._af(a)) this._v(a);
        ...
        var b;
        b = this.b.defaultCountry ? this._y(this.b.defaultCountry, !1, !1) : this.preferredCountries.length ? this.preferredCountries[0] : this.l[0], this._z(b.iso2), a || this._ae(b.dialCode, !1)
      }
      a && this._u(a, !1)
    },
    _i: function() {
      var c = this;
      this._j(), (this.b.autoHideDialCode || this.b.autoFormat) && this._l();
      ...
      }), this.b.utilsScript && (j ? this.loadUtils() : a(b).load(function() {
        c.loadUtils()
      }))
    },
    _j: function() {
      var a = this;
      this.b.autoFormat && this.g.on("keypress" + this.ns, function(c) {
        ...
        if (c.which == i.ENTER);
        else if (a.b.autoFormat && b.intlTelInputUtils) {
          var d = c.which == i.CTRL || c.which == i.CMD1 || c.which == i.CMD2,
            e = a.g[0],
            f = a.d && e.selectionStart == e.selectionEnd,
            g = a.d && e.selectionStart == a.g.val().length;
          if ((c.which == i.DEL && !g || c.which == i.BSPACE || d && f) && a._k(null, d && g), !a.b.nationalMode) {
            var h = a.g.val();
            if ("+" != h.substr(0, 1)) {
    ...
    _l: function() {
      var a = this;
      this.b.autoHideDialCode && this.g.on("mousedown" + this.ns, function(b) {
        a.g.is(":focus") || a.g.val() || (b.preventDefault(), a.g.focus())
      }), this.g.on("focus" + this.ns, function() {
        var c = a.g.val();
        a.g.data("focusVal", c), a.b.autoHideDialCode && (c || (a._u("+" + a.o.dialCode, !0), a.g.one("keypress.plus" + a.ns, function(c) {
          if (c.which == i.PLUS) {
            var d = a.b.autoFormat && b.intlTelInputUtils ? "+" : "";
            a.g.val(d)
          }
        }), setTimeout(function() {
          var b = a.g[0];
        ...
        a.b.autoFormat && b.intlTelInputUtils && a.g.val() != a.g.data("focusVal") && a.g.trigger("change")
      })
    },
    _m: function(a) {
    ...
    _p: function() {
      ...
      a(c).on("keydown" + this.ns, function(a) {
        a.preventDefault(), a.which == i.UP || a.which == i.DOWN ? b._q(a.which) : a.which == i.ENTER ? b._r() : a.which == i.ESC ? b._ac() : (a.which >= i.A && a.which <= i.Z || a.which == i.SPACE) && (f && clearTimeout(f), e += String.fromCharCode(a.which), b._s(e), f = setTimeout(function() {
          e = ""
        }, 1e3))
      })
    },
    _q: function(a) {
      ...
      c.length && (c.hasClass("divider") && (c = a == i.UP ? c.prev() : c.next()), this._x(c), this._ad(c))
    },
    _r: function() {
    ...
    _u: function(a, c) {
      var d;
      if (this.b.autoFormat && b.intlTelInputUtils) {
    ...
    _v: function(a) {
      this.b.nationalMode && this.o && "1" == this.o.dialCode && "+" != a.substr(0, 1) && (a = "+1" + a);
      var b = this._af(a);
      if (b) {
    ...
    _x: function(a) {
      this.iItems.removeClass("highlight"), a.addClass("highlight")
    },
    _y: function(a, b, c) {
    ...
    _z: function(a) {
      ...
      var c = this.iItems.children(".flag." + a).first().parent();
      this.iItems.removeClass("active"), c.addClass("active")
    },
    _aa: function() {
      if (b.intlTelInputUtils && !this.e) {
        var a = this.o.iso2,
          c = this.b.numberType ? intlTelInputUtils.numberType[this.b.numberType] : intlTelInputUtils.numberType.FIXED_LINE,
          d = intlTelInputUtils.getExampleNumber(a, this.b.nationalMode, c);
    ...
    _ae: function(b, c) {
      var d, e = this.g.val();
      if (b = "+" + b, this.b.nationalMode && "+" != e.substr(0, 1)) d = e;
      else if (e) {
        var f = this._af(e);
      ...
      } else d = !this.b.autoHideDialCode || c ? b : "";
      this._u(d, c)
    },
    _af: function(b) {
      var c = "";
    ...
    setNumber: function(a, b) {
      this.b.nationalMode || "+" == a.substr(0, 1) || (a = "+" + a), this._v(a), this._u(a, b)
    },
    utilsLoaded: function() {
      this.b.autoFormat && this.g.val() && this._u(this.g.val()), this._aa()
    }
  }, a.fn[f] = function(b) {
    var c = arguments;
